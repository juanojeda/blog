...
> Teams are like functions in fp. If you change the inputs, they're no longer the same team[^heavily-paraphrased]
...
There are ways to speed up this forming process, and there are probably even ways to reduce the disruption caused by changes of input (team charters, personal FAQs, ways of working sessions, etc.), but to me this is more about recognising that a team is really just a collection of people in a context, and if the people or context change, the team also changes.
