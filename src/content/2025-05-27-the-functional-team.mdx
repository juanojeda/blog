...
summary: In which I reflect on a previous manager's analogy that teams are immutable values in functional programming.
date: 2025-05-27
tags:
  - teams
  - engineering
...
> Teams are like immutable values in fp. If you change the inputs, they're no longer the same team[^heavily-paraphrased]

To understand this analogy, you have to understand a bit about Functional Programming (FP) – which, in the team this manager was leading, was the programming ideology of choice. In FP, values are immutable - once they're created, they can't be modified. A function that takes a set of inputs will always produce the same output, and if you change the inputs, you'll get a different output.
