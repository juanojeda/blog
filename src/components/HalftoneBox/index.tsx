...
const HalftoneBox = styled(Box, {
  ...
  "&::before": {
    ...
    height,
    left: 0,
    backgroundImage: `radial-gradient(circle, ${theme.palette.primary.light} 1px, transparent 0), radial-gradient(circle, ${theme.palette.primary.light} 1px, transparent 0)`,
